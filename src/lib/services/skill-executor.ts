...
Use the Scheduled Tasks panel to complete task setup.`,
  ...
  private async handleSetupCoworkSkill(skill: Skill, args: string): Promise<ExecutionResult> {
    ...
    const steps = [
      {
        id: "plugin",
        title: "1. Install Plugin",
        description:
          "The Cowork plugin provides file system access, browser automation, scheduled tasks, and skill execution.",
        action: "Install Plugin",
        command: "/plugin install cowork",
      },
      {
        id: "directory",
        title: "2. Connect Your Project",
        description: "Add a directory to your workspace to enable file operations.",
        action: "Add Directory",
        command: "/add-dir",
      },
      {
        id: "try-skill",
        title: "3. Try a Built-in Skill",
        description: "Start with one of these popular skills:",
        skills: [
          { name: "/schedule", desc: "Create your first scheduled task" },
          { name: "/consolidate-memory", desc: "Organize your memory files" },
          { name: "/init", desc: "Initialize a CLAUDE.md for a project" },
        ],
      },
      {
        id: "marketplace",
        title: "4. Explore the Marketplace",
        description: "Discover more skills and integrations in the Skill Marketplace.",
