<script lang="ts">
  ...
  let {
    cwd: _cwd = "",
    runId: _runId = "",
    toolStats: _toolStats,
    onSwitchToActivity: _onSwitchToActivity,
    onSwitchToFiles: _onSwitchToFiles,
    worktreePath: _worktreePath = null,
    parentCwd: _parentCwd = null,
    worktreeBranch: _worktreeBranch = null,
    creationMode: _creationMode = null,
    processVisibility: _processVisibility = "developer" as ProcessVisibility,
    contextPanel,
    target = null,
    onTargetConsumed,
  }: {
