  ...
  function getStatusInfo(status: PipelineStepStatus): {
    ...
    switch (status) {
      case "running":
        return {
          bgClass:
            "fill-[hsl(var(--miwarp-status-info)/0.2)] stroke-[hsl(var(--miwarp-status-info))]",
      ...
      case "completed":
        return {
          bgClass:
            "fill-[hsl(var(--miwarp-status-success)/0.2)] stroke-[hsl(var(--miwarp-status-success))]",
      ...
      case "failed":
        return {
          bgClass:
            "fill-[hsl(var(--miwarp-status-error)/0.2)] stroke-[hsl(var(--miwarp-status-error))]",
...
<div class="relative" style="min-width: {layout.width}px">
  ...
  {#if !compact}
    <div class="flex items-center gap-4 mt-3 text-[10px] text-muted-foreground">
      ...
      <div class="flex items-center gap-1">
        <div
          class="w-2.5 h-2.5 rounded-full bg-[hsl(var(--miwarp-status-info)/0.2)] border border-miwarp-status-info"
        ></div>
        <span>{t("skillPipeline_running")}</span>
      </div>
      <div class="flex items-center gap-1">
        <div
          class="w-2.5 h-2.5 rounded-full bg-[hsl(var(--miwarp-status-success)/0.2)] border border-miwarp-status-success"
        ></div>
        <span>{t("skillPipeline_completed")}</span>
      </div>
      <div class="flex items-center gap-1">
        <div
          class="w-2.5 h-2.5 rounded-full bg-[hsl(var(--miwarp-status-error)/0.2)] border border-miwarp-status-error"
        ></div>
