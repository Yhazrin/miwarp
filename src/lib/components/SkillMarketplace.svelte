...
<div class="skill-marketplace">
  <!-- Header -->
  <div class="mb-4">
    <h2 class="text-lg font-semibold">{t("skillMarketplace_title")}</h2>
    <p class="text-sm text-muted-foreground">
      {t("skillMarketplace_description")}
    </p>
  </div>
  ...
  <div class="relative mb-4">
    ...
    <input
      ...
      placeholder={t("skillMarketplace_search")}
  ...
  {:else if filteredSkills().length === 0}
    ...
    <div class="flex h-40 flex-col items-center justify-center gap-2 text-center">
      ...
      <p class="text-sm text-muted-foreground">
        {searchQuery ? t("skillMarketplace_noResults") : t("skillMarketplace_noSkills")}
      </p>
    </div>
  {:else}
    <!-- Skills Grid -->
