...
export function buildExportFilename(title: string): string {
  return `miwarp-${sanitizeFilename(title)}-${dateStr()}.html`;
}
...
<head>
  ...
  <meta name="generator" content="MiWarp">
  <title>${title} — MiWarp</title>
  <style>
${styles}
/* Export overrides */
...
<body class="bg-background text-foreground">
  ...
  <footer style="max-width:48rem;margin:0 auto;padding:1.5rem;text-align:center;font-size:0.75rem;color:hsl(var(--muted-foreground))">
    Generated by <a href="https://github.com/AnyiWang/MiWarp" style="color:hsl(var(--primary))">MiWarp</a>
  </footer>
  <script>
