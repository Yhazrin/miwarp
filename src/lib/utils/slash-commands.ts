...
const KNOWN_COMMAND_DESCRIPTIONS: Record<string, MessageKey> = {
  ...
  compact: "slash_desc_compact",
  config: "slash_desc_config",
  context: "slash_desc_context",
  copy: "slash_desc_copy",
  cost: "slash_desc_cost",
  diff: "slash_desc_diff",
  fast: "slash_desc_fast",
  doctor: "slash_desc_doctor",
  feedback: "slash_desc_feedback",
  files: "slash_desc_files",
  fork: "slash_desc_fork",
  help: "slash_desc_help",
  hooks: "slash_desc_hooks",
  plugin: "slash_desc_plugin",
  ide: "slash_desc_ide",
  init: "slash_desc_init",
  insights: "slash_desc_insights",
  keybindings: "slash_desc_keybindings",
  login: "slash_desc_login",
  logout: "slash_desc_logout",
  mcp: "slash_desc_mcp",
  memory: "slash_desc_memory",
  model: "slash_desc_model",
  plan: "slash_desc_plan",
  "pr-comments": "slash_desc_prComments",
  "release-notes": "slash_desc_releaseNotes",
  rename: "slash_desc_rename",
  resume: "slash_desc_resume",
  review: "slash_desc_review",
  "security-review": "slash_desc_securityReview",
  simplify: "slash_desc_simplify",
  skills: "slash_desc_skills",
  "reload-skills": "slash_desc_reloadSkills",
  status: "slash_desc_status",
  theme: "slash_desc_theme",
  tasks: "slash_desc_tasks",
  todos: "slash_desc_todos",
  usage: "slash_desc_usage",
  vim: "slash_desc_vim",
  "add-dir": "slash_desc_addDir",
  btw: "slash_desc_btw",
  loop: "slash_desc_loop",
  schedule: "slash_desc_schedule",
  "team-onboarding": "slash_desc_teamOnboarding",
};
...
export const VIRTUAL_COMMANDS: CliCommand[] = [
  ...
  {
    name: "status",
    description: "slash_desc_statusOverview",
    aliases: ["info"],
    _virtual: true,
    _action: "show-status",
  },
  {
    name: "help",
    description: "slash_desc_showCommands",
    aliases: ["h", "?"],
    _virtual: true,
    _action: "show-help",
  },
  {
    name: "doctor",
    description: "slash_desc_diagnose",
    aliases: [],
    _virtual: true,
    _action: "run-doctor",
  },
  {
    name: "diff",
    description: "slash_desc_gitDiff",
    aliases: [],
    _virtual: true,
    _action: "show-diff",
  },
  {
    name: "todos",
    description: "slash_desc_listTodos",
    aliases: ["todo"],
    _virtual: true,
    _action: "list-todos",
  },
  {
    name: "tasks",
    description: "slash_desc_listTasks",
    aliases: [],
    _virtual: true,
    _action: "list-tasks",
  ...
  {
    name: "permissions",
    description: "slash_desc_openPermissions",
    aliases: [],
    _virtual: true,
  ...
  {
    name: "plugin",
    description: "slash_desc_openPlugins",
    aliases: ["plugins"],
    _virtual: true,
    _navigate: "/plugins",
  },
  {
    name: "btw",
    description: "slash_desc_sideQuestion",
    aliases: [],
    _virtual: true,
  ...
  {
    name: "stickers",
    description: "slash_desc_stickers",
    aliases: ["sticker"],
    _virtual: true,
  ...
  {
    name: "keybindings",
    description: "slash_desc_openKeybindings",
    aliases: [],
    _virtual: true,
  ...
  {
    name: "preview",
    description: "slash_desc_preview",
    aliases: [],
    _virtual: true,
  ...
  {
    name: "cancel-ralph",
    description: "slash_desc_cancelRalph",
    aliases: ["stop-ralph"],
    _virtual: true,
  ...
  {
    name: "schedule",
    description: "slash_desc_scheduleNav",
...
const CATEGORY_LABELS: Record<SlashCategory, MessageKey> = {
  ...
  help: "slash_cat_help",
  skills: "slash_cat_skills",
  other: "slash_cat_other",
};
