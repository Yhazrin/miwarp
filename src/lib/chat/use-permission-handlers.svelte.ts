/**
 * Composable: permission and elicitation handlers.
 *
 * Handles permission responses, tool approvals, hook callbacks, and ExitPlanMode
 * context clearing. All functions require access to the session store and API.
 */
...
export function usePermissionHandlers(opts: {
