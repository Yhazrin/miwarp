...
export const LUCIDE_PATHS: Record<LucideIconName, SvgPart[]> = {
  ...
  folder: [
    { t: "path", d: "M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" },
  ],
  "folder-open": [
    {
      t: "path",
  ...
  hand: [
    ...
    {
      t: "path",
      d: "M18 8a2 2 0 1 1 4 0v8a8 8 0 0 1-8 8h-2c-2.8 0-4.5-.86-5.99-2.34l-1.2-1.2a2 2 0 0 1 2.83-2.83l.79.79",
    },
  ],
  "mouse-pointer": [
    { t: "path", d: "M12 2v4" },
  ...
  "mouse-pointer-2": [
    {
      t: "path",
      d: "M4.037 4.688a.5.5 0 0 1 .651-.651l16 6.5a.5.5 0 0 1-.063.947l-6.124 1.58a2 2 0 0 0-1.438 1.435l-1.579 6.124a.5.5 0 0 1-.947.063z",
    },
  ],
  upload: [
