...
import type { SoundCategory, SoundRole } from "$lib/sensory/config/sound-roles";
import type { SoundSource } from "$lib/sensory/config/engine";
import { packRegistry, type SoundPackName } from "$lib/sensory/config/registry";
